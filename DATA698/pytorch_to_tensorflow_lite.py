# Originally from https://github.com/kalaspuffar/onnx-convert-example
# Running the script python3 pytorch_to_tensorflow_lite.py models/mnist.pth models
import sys
import os
import torch
...
trained_model = MLP(784, [256, 256], 10) #input_dims, n_hiddens, n_class
