...
I will start by looking at the training data and the decomposition.  I cannot use the `decompose()` or `stl()` functions to decompose it because I don't have enough data.  Facebook Prophet can decompose it using its Basian process.
