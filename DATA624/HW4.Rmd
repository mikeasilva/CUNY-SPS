...
**If one of the important variables has a lot of missing data I would use knn to fill in the holes with this categorical data.  If the variables were quantitative I would probably use the mean or median or k-means to fill in those holes.**
