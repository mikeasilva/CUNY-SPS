...
```{r}
ggtsplot(diff(usnetelec, 1), "Differenced US Net Electricity Generation (lag=1)")
```

```{r}
#ur.kpss(diff(usnetelec, 1)) 
#Box.test(diff(usnetelec, 1), lag = 1)
