...
**This was and interesting exercise.  Some of the more sophisticated approaches preformed less well on the test set than the seasonal naïve model.  In the end the `r rmse_df[rmse_df$RMSE == min(rmse_df$RMSE),]$Model` preformed the best on the test set.**
