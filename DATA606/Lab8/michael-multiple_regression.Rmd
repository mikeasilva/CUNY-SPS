...
3.  Excluding `score`, select two other variables and describe their relationship 
    ...
    **Academia attracts people with below average beauty.  The median beauty score on a scale of 1 to 10 is a 4.  Males are less attractive than females.**
...
6.  Use residual plots to evaluate whether the conditions of least squares
    ...
    **Nearly normal residuals: The plot below shows the Q to Q plot but it doesn't hold to the line the best.**
