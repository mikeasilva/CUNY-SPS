...
(a) Write hypotheses for evaluating whether the average number of hours worked varies across the five groups. **H0: $\mu$1 = $\mu$2 = $\mu$3 = $\mu$4 = $\mu$5 and HA: The average varies across some or all groups.**
