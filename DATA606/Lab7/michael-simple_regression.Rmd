...
1.  What type of plot would you use to display the relationship between `runs` 
    ...
    ```
    Doe the relationship look linear? **Yes it looks somewhat linear.** If you knew a
    team's `at_bats`, would you be comfortable using a linear model to predict the 
