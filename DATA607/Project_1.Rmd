...
I really enjoy graph theory and couldn't pass up the oportunity to create a network graph from this chess data and visualize it.  I will use the igraph library to do that.  This is beyond the scope of the project and is for the fun of it.
