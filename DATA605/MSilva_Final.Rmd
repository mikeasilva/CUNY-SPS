...
*It appears there is an NA in the submission.  In the interest of getting my final turned in on time I will be using the median to plug that hole.*

```{r}
fill <- median(submission$SalePrice, na.rm = TRUE)
submission <- submission %>%
  mutate(SalePrice = replace_na(SalePrice, fill))
write.csv(submission, "submission.csv", quote = FALSE, row.names =  FALSE)
```

*My Kaggle score is* **0.47768** *and my username is* **mikesilva***.  I am ranked 4520 on the leaderboard.  I will try to improve this score when I have time.*

*This analysis is available on  [GitHub](https://github.com/mikeasilva/CUNY-SPS/blob/master/DATA605/MSilva_Final.Rmd).*