...
Again these results are highly dependent on the underling data, and additional runs should be done in order to ensure the conclusions are real and not soley based on idiosyncrasies in the data.  The idea is inline with what has been taught in this class.